...
try:
    ...
    if err.errno == errorcode.ER_ACCESS_DENIED_ERROR:
        ...
        print(err)
##
##        # open the default config to connect to your localhost (in most cases 127.0.0.1:3306)
##        with open("mysqlconfigdefault.csv","r") as defaultconfigfile:
##            reader = csv.reader(defaultconfigfile)
##            data = list(reader)
##
##        # the default config to connect to your localhost (127.0.0.1:3306)
##        defaultconfig = {
##          "user": data[1][3],
##          "password": data[1][4],
##          "host": data[1][0],
...
##        }
##        
##        cnx = mysql.connector.connect(**defaultconfig)
##        mysql_cursor = cnx.cursor()
##        mysql_cursor.execute(f" CREATE DATABASE {data[1][2]}")
...
##         ) """)
## 
##     squlite_cursor.execute(create_nutzer_table) # create antwort_table in sqlite
##     print("Table nutzer_table successfully created!")
##     squlite_cursor.execute(create_antwort_table) # create antwort_table in sqlite
##     squlite_cursor.execute(create_frage_table) # create nutzer_table in sqlite
## 
## 
...
### creating tables the in MySQL 8 ###

DB_NAME = data[1][2] # specifying the database name from file
...
##mysql_cursor.execute(create_nutzer_table) # create antwort_table in mysql
print("Table antwort_table successfully created!")

##mysql_cursor.execute(create_frage_table) # create antwort_table in mysql
print("Table nutzer_table successfully created!")

##mysql_cursor.execute(create_antwort_table) # create antwort_table in mysql 
print("Table frage_table successfully created!")

print("Database successfully created!")
## else:
##    print("MySQL Error: Database exists already!") 
