...
# code starting with ## is marked as code which may be useful for debugging or may be worked on in future releases
...
def get_current_hw():
    current_h_app,current_w_app  = app.winfo_height(),app.winfo_width()
    print(f"{current_w_app}x{current_h_app}")
##    return current_hw_list
...
searchbarframe = customtkinter.CTkFrame(master=app, width=screen_width, height=8, corner_radius=15) # frame container for searchbar
searchbarframe.pack(side="top", pady=1, fill="both")

searchbox = customtkinter.CTkEntry(master=searchbarframe, placeholder_text="Suchen... ") #searchbox top left
...
login_button = customtkinter.CTkButton(master=searchbarframe, width=30,height=30,text="Einloggen ", command=login_screen) #login button top right
...
optionmenu_2 = customtkinter.CTkOptionMenu(searchbarframe, values=["Alle", "Option 42 long long long...","Test"])
...
main_content_frame_left = customtkinter.CTkFrame(master=app, height=1280, width=0, corner_radius=15) #main content frame left
main_content_frame_left.pack(side="left",pady=5, padx=5, fill="both")

main_content_frame_center = customtkinter.CTkFrame(master=app, height=1280, width=0, corner_radius=15) # main content frame "center"
main_content_frame_center.pack(side="left",pady=5, padx=5, fill="both")

main_content_frame_right = customtkinter.CTkFrame(master=app, height=1280, width=0, corner_radius=15) #main content frame right
main_content_frame_right.pack(side="right",pady=5, padx=5, fill="both")

##labeltest = customtkinter.CTkLabel(searchbarframe,text=f"{get_current_wh()}")
...
if __name__ == "__main__":
    ...
    app.after(17,tasks)
    main_content_frame_left = customtkinter.CTkFrame(master=app, height=, width=0, corner_radius=15) #main content frame left
    main_content_frame_left.pack(side="left",pady=5, padx=5, fill="both")
